...
import initSysAdmin from '$server/dbEdge/init/dbEdgeInit2DOSysAdmin'
import initCMStudent from '$server/dbEdge/init/dbEdgeInit2DOCMStudent'
...
async function reset() {
	...
	resetDb.addTable('sys_core::SysDataObjFieldChips')
